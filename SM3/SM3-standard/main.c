...
int SM3_SelfTest()
{
    ...
    a=memcmp(MsgHash1,StdHash1,SM3_len/8);//�������ֵ = 0�����ʾ MsgHash1 ���� StdHash1
    b=memcmp(MsgHash2,StdHash2,SM3_len/8);
    if ((a==0) && (b==0))
    {
        printf("input message1: ");
        print_Hashvalue(Msg1,3);
        printf("ouput hash value1: ");
        print_Hashvalue(MsgHash1,32);

        printf("\ninput message2: ");
        print_Hashvalue(Msg2,64);
        printf("ouput hash value2: ");
        print_Hashvalue(MsgHash2,32);
        return 0;
    }
    else
    {
...
/******************************************************************************
    Function: print_Hashvalue
    Description: print hash value
    Calls:
    Called By:
    Input: unsigned char buf[len] //the input message
           int len //bytelen of the message
    Output: print hash value
    Return: null
    Others:
*******************************************************************************/
